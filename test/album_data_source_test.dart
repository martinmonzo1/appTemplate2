...
import 'package:app_template/model/data_source/post_data_source.dart';
...
void main() {
  group('getAlbum', () {
    test('returns an Album if the http call completes successfully', () async {
      ...
      expect(await albumDataSource.get(client), isA<Album>());
    });

    test('throws an exception if the http call completes with an error', () {
      final client = MockClient();
      final PostDataSource postDataSource = PostDataSource();
      ...
      expect(postDataSource.get(client), throwsException);
    });
  });
}